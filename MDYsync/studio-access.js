(() => {
  ...
  async function submitLogin(event) {
    ...
    try {
      ...
      const message = error instanceof AuthError && error.status === 401 ? "The email or password is incorrect." : error?.message || "The editor login is temporarily unavailable.";
      showMessage(message);
    } finally {
